...
# picked from https://github.com/meta-llama/llama-models/blob/main/models/llama4/tokenizer.py
...
class Llama4Tokenizer:
    ...
    def get_instance(cls, model_path: Path):
        ...
        if _INSTANCE is None:
            _INSTANCE = Llama4Tokenizer(model_path=model_path)
        return _INSTANCE
