...
VOCAB_FILES_NAMES = {"vocab_file": "qwen_tokenizer.model"}
...
class QWenTokenizer(PreTrainedTokenizer):
    ...
    def get_instance(cls, model_path: Path):
        ...
        if _INSTANCE is None:
            _INSTANCE = cls(model_path=model_path)
        return _INSTANCE
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.mergeable_ranks = self._load_tiktoken_bpe(model_path)  # type: Dict[bytes, int]
        self.special_tokens = {
            token: index
        ...
        if extra_model_path is not None:
            ...
            extra_mergeable_ranks = self._load_tiktoken_bpe(extra_model_path)
