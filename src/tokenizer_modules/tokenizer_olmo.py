...
class OLMoTokenizer:
    ...
    def __init__(
        ...
        truncate_direction: Union[str, str] = "right",
    ):
    ...
    @classmethod
    def from_train_config(cls, config: dict) -> OLMoTokenizer:
        ...
        elif Path(tokenizer_identifier).is_file():
            tokenizer = cls.from_file(
                Path(tokenizer_identifier),
                eos_token_id=config["model"]["eos_token_id"],
                pad_token_id=config["model"]["pad_token_id"],
            )
        else:
        ...
        if config.model.vocab_size != tokenizer.vocab_size:
            raise ValueError("vocab size mismatch between config and tokenizer")
        return tokenizer

    @classmethod
    def from_pretrained(cls, identifier: str, **kwargs) -> OLMoTokenizer:
        """
